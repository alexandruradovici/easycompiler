...
import { TreeVisitor } from '@easycompiler/frontend/parsetree/visitor/TreeVisitor';
...
let treeWalker = new TreeVisitor (flattenedParseTree);
treeWalker.printSignatures ();